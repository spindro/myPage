...
[**Social EgoMesh Estimation**](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=0glmB_UAAAAJ&cstart=20&pagesize=80&citation_for_view=0glmB_UAAAAJ:KlAtU1dfN6UC)   
*L Scofano, A Sampieri, E De Matteis, I Spinelli, F Galasso*
<sm>
In Proc. of the Winter Conference on Applications of Computer Vision (WACV) 2025
</sm>

[**Length-Aware Motion Synthesis via Latent Diffusion**](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=0glmB_UAAAAJ&citation_for_view=0glmB_UAAAAJ:3fE2CSJIrl8C)   
*A Sampieri, A Palma, I Spinelli, F Galasso*
<sm>
In Proc. of the European Conference on Computer Vision (ECCV) 2024
</sm>

[**OVOSE: Open-Vocabulary Semantic Segmentation in Event-Based Cameras**](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=0glmB_UAAAAJ&citation_for_view=0glmB_UAAAAJ:kNdYIx-mwKoC)
*MRU Rahman, JH Giraldo, I Spinelli, S Lathuilière, F Galasso*
<sm>
In Proc. of the International Conference on Pattern Recognition (ICPR) 2024
</sm>

[**From latent graph to latent topology inference: differentiable cell complex module**](https://scholar.google.com/citations?view_op=view_citation&hl=en&user=0glmB_UAAAAJ&citation_for_view=0glmB_UAAAAJ:WF5omc3nYNoC)   
*C Battiloro\*, I Spinelli\*, L Telyatnikov, M Bronstein, S Scardapane, P Di Lorenzo*
<sm>
...
<sm>
In Proc. of European Symposium on Artificial Neural Networks, Computational Intelligence and
...
<sm>
In Proc. of 2nd Annual Workshop on Topology, Algebra, and Geometry in Machine Learning (TAG-ML) 2023
</sm>
...
<sm>
In Proc. of the Northern Lights Deep Learning Workshop (NLDL)   2023
</sm>
...
<sm>
Progresses in Artificial Intelligence and Neural Systems    2020
</sm>